...
import com.justino.sistempakar.BeritaPakarAdapter;
...
public class TampilDataBeritaPakar extends AppCompatActivity {
    ...
    public static TampilDataBeritaPakar ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_databeritapakar);
        btnTambahProduk = findViewById(R.id.btnTambahBerita);
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.rv_beritaa);
        ...
        backlistmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TampilDataBeritaPakar.this, DashboardAdmin.class);
        ...
        btnTambahProduk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(TampilDataBeritaPakar.this,TambahDataBerita.class);
                startActivity(intent);
            }
        });
    ...
    public void tampilberita() {
        ...
        call.enqueue(new Callback<GetBerita>() {
            ...
            public void onResponse(Call<GetBerita> call, Response<GetBerita>
                ...
                mAdapter = new BeritaPakarAdapter(beritaList);
        ...
        call.enqueue(new Callback<GetBerita>() {
            ...
            public void onResponse(Call<GetBerita> call, Response<GetBerita>
                ...
                Log.d("Retrofit Get", "Jumlah data Berita: " +
                        String.valueOf(beritaList.size()));
                Toast.makeText(TampilDataBeritaPakar.this, "Jumlah berita = " + (beritaList.size()), Toast.LENGTH_SHORT).show();
                mAdapter = new BeritaPakarAdapter(beritaList);
                mRecyclerView.setAdapter(mAdapter);
            ...
            public void onFailure(Call<GetBerita> call, Throwable t) {
                Log.e("Retrofit Get", t.toString());
                Toast.makeText(TampilDataBeritaPakar.this, "Gagal memuat produk  " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}
