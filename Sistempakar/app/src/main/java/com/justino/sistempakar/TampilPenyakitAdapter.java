...
public class TampilPenyakitAdapter extends RecyclerView.Adapter<TampilPenyakitAdapter.MyViewHolder>{
    List<Penyakit> mpenyakitList;

    public TampilPenyakitAdapter(List<Penyakit> penyakitList) {
    ...
    public MyViewHolder onCreateViewHolder (ViewGroup parent, int viewType){
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_data_tampilpenyakit, parent, false);
