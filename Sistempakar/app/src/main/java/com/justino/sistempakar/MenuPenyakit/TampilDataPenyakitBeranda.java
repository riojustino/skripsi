...
import com.justino.sistempakar.TampilPenyakitAdapter;
...
public class TampilDataPenyakitBeranda extends AppCompatActivity {
    ...
    public static TampilDataPenyakitBeranda ma;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_datatampilpenyakit);
        ...
        mRecyclerView = (RecyclerView) findViewById(R.id.rv_produkk);
...
//        ma=this;
        ...
        backlistmenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TampilDataPenyakitBeranda.this, Dashboard.class);
        ...
        call.enqueue(new Callback<GetPenyakit>() {
            ...
            public void onResponse(Call<GetPenyakit> call, Response<GetPenyakit>
                    response) {
                        ...
                        mAdapter = new TampilPenyakitAdapter(penyakitList);
        ...
        call.enqueue(new Callback<GetPenyakit>() {
            ...
            public void onResponse(Call<GetPenyakit> call, Response<GetPenyakit>
                ...
                Log.d("Retrofit Get", "Jumlah data Penyakit: " +
                        String.valueOf(penyakitList.size()));
                Toast.makeText(TampilDataPenyakitBeranda.this, "Jumlah penyakit = " + (penyakitList.size()), Toast.LENGTH_SHORT).show();
                mAdapter = new TampilPenyakitAdapter(penyakitList);
                mRecyclerView.setAdapter(mAdapter);
            ...
            public void onFailure(Call<GetPenyakit> call, Throwable t) {
                Log.e("Retrofit Get", t.toString());
                Toast.makeText(TampilDataPenyakitBeranda.this, "Gagal memuat produk  " + t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    }
}
